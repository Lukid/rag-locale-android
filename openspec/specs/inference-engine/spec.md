...
Caricare ed eseguire il modello LLM attivo on-device tramite LiteRT-LM, gestendo la scelta del backend di esecuzione (GPU/CPU), il fallback automatico e il ciclo di vita del modello residente per la durata della sessione di chat.
